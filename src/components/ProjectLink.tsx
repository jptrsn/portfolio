          ...
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            <defs
              ...
              <linearGradient
                ...
                gradientTransform="matrix(0.05728638,0,0,0.05953584,-2.6643,-3.2414647)">
                <stop
                  offset="0"
                  stopColor="#ffffff"
                  stopOpacity="0"
            ...
            <path
              fill="url(#A)"
              d="m 12.218932,6.3676206 c -0.02521,0 -0.06302,0 -0.07562,0.026196 l -0.0252,0.06549 4.238962,16.5075034 a 11.00122,11.433204 0 0 0 4.970739,-4.431669 L 12.294607,6.4069143 a 0.10093861,0.10490216 0 0 0 -0.07568,-0.039353 z"
              opacity="0.5"
              paintOrder="stroke markers fill"
              id="path3"
              />
            <path
              d="M 11.960913,1.033209 A 10.998986,11.430882 0 0 0 2.6805197,18.536746 L 11.85207,6.2128274 c 0.02865,-0.035721 0.08593,-0.059536 0.148945,-0.059536 0.06302,0 0.114571,0.023814 0.148944,0.059536 L 21.31578,18.536746 A 10.998986,11.430882 0 0 0 23,12.464092 C 23,6.1532916 18.073371,1.033209 12.001015,1.033209 a 10.998986,11.430882 0 0 0 -0.04011,0 z"
              paintOrder="stroke markers fill"
              id="path4" />
          </svg>
        )
